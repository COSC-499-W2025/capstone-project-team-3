...
def main(argv: Optional[list] = None) -> int:
    ...
    parser.add_argument("--root", "-r", help="Provide root path to a ZIP archive (required)")
    ...
    if resolved.suffix.lower() != ".zip":
        print(json.dumps({"status": "error", "reason": "Only ZIP archives are accepted as input."}))
        return 1
