...
def extract_commit_hash(path: Union[str, Path]) -> list:
...
def extract_commit_message(path: Union[str, Path]) ->list:
...
def extract_commit_authored_datetime(path: Union[str, Path]) ->list:
    """
...
def extract_commit_datetime(path: Union[str, Path]) ->list:
    """
...
def extract_commit_author(path: Union[str, Path]) ->list:
